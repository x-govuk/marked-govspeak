...
describe('Govspeak', () => {
  ...
  it('Renders address', () => {
    assert.equal(
      marked('$A\nLine 1  \nLine 2\n$A'),
      '<address class="govspeak-address h-adr">\n  <p>Line 1<br>Line 2</p>\n\n</address>'
    )
  })
  ...
  it('Renders button', () => {
    assert.equal(
      ...
      '<p><a class="govuk-button" href="https://gov.uk" role="button">Click me</a></p>\n'
    )
  })
  ...
  it('Renders start button', () => {
    assert.equal(
      ...
      '<p><a class="govuk-button govuk-button--start" href="https://gov.uk" role="button">Click me<svg class="govuk-button__start-icon" xmlns="http://www.w3.org/2000/svg" width="17.5" height="19" viewBox="0 0 33 40" aria-hidden="true" focusable="false"><path fill="currentColor" d="M0 0h13l20 20-20 20H0l20-20z"/></svg></a></p>\n'
    )
  })
